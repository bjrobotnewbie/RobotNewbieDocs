...
| **协同层** | [多机器人系统](docs/guide/multi-robot-systems/README.md) | 地面群体、无人机集群、水下/微纳米/太空群体协同 | 🤝 群体协同 |
| **应用层** | [应用场景](docs/guide/applications/README.md) | 人形、工业、医疗、服务、农业、无人机 | 🏭 场景落地 |

## 网站热点

首页设有 **机器人开源热点榜** 栏目，聚合 GitHub 上近期活跃的机器人、具身智能、ROS、仿真、导航与控制等领域的开源项目，帮助你快速发现值得关注的前沿热点。

**点击图片查看热点页面**

[![热点截图](assets/images/hot_trend.png)](https://docs.robotnewbie.com/trends)

热点榜提供多种筛选方式，方便快速定位感兴趣的项目：

- 🕐 **周期切换**：支持周榜 / 月榜，查看不同周期的热门项目
- 🔍 **关键词搜索**：按项目名称、描述、语言、分类等关键词快速检索
- 🗂️ **语言与分类筛选**：按编程语言或领域分类过滤项目
- 📊 **多维排序**：按 Stars 数量、Stars 增量、Forks、最后更新时间等字段排序
- ⏳ **滚动加载**：向下滚动自动加载更多项目

⏰ 热点榜**一般每周更新一次**，持续跟踪领域内最新动态。
