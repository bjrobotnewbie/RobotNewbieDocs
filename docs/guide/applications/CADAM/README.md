...
## 主要特性
1.  **AI驱动生成**：将自然语言、图片转换为3D模型
2.  **参数化控制**：提供交互式滑块快速调整模型尺寸
3.  **多格式导出**：支持导出STL、SCAD、DXF文件
4.  **纯浏览器运行**：依托WebAssembly无需本地安装依赖
5.  **内置开源库**：集成BOSL、BOSL2、MCAD常用CAD库
