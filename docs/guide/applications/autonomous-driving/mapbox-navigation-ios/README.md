...
## 主要特性
1.  支持iPhone、iPad和CarPlay的预制逐turn导航UI，可快速集成到现有应用
2.  提供专业设计的日间、夜间地图样式
3.  支持全球55个以上国家的驾车、骑行、步行路线规划，数据基于公开数据源与用户反馈
4.  基于实时路况实现避障与主动重新规划路线
5.  内置基于Amazon Polly的自然语音转向提示，无需额外配置
6.  支持二十余种语言的本地化适配
