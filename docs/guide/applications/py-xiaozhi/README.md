...
集成MCP、支持多模态工作流与IoT、具备跨平台语音交互的开源AI助手生态系统。
...
## 主要特性
1.  支持MCP集成，可对接多类AI大模型API
2.  具备多模态交互工作流，适配语音、文本等多种交互形式
3.  支持IoT设备接入，可实现智能设备联动控制
4.  跨平台语音交互能力，适配多终端使用场景
5.  提供完善的使用文档，便于快速部署和开发
