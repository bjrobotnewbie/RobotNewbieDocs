...
用于自主无人机的开源Web地面控制站。支持飞控配置、传感器校准、任务规划、MAVLink协议、手动飞行控制。支持多无人机机群与配套软件，打造真正的软件定义无人机。
...
## 主要特性
1.  完整地面站功能：支持飞控面板配置、传感器校准、任务规划、手动飞行控制
2.  多机队管理：支持多无人机编队操控
3.  特色功能：内置任务模式生成器、50Hz刷新率的手柄/ HOTAS手动操控、AI辅助PID调参、Cesium 3D地形 globe与飞行路径回放
4.  轻量化使用：无需本地安装，直接通过浏览器访问使用
