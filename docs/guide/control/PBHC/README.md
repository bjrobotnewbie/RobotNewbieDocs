...
论文《KungfuBot：基于物理的人形机器人全身控制用于学习高动态技能》的官方实现
...
## 主要特性
1.  支持基于物理仿真的类人机器人全身控制，可学习高动态运动技能
2.  提供完整的训练与部署代码框架，可复现论文中的实验效果
3.  支持多类运动技能的泛化学习，覆盖复杂动态人形动作
4.  配套官方项目页面与论文预印本资源，方便开发者参考学习
