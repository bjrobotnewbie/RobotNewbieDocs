...
基于地面计划先验的 360 度视觉 - 惯性 SLAM 与定位基准
...
## 主要特性
1.  **核心功能**：为360视觉惯性SLAM与定位任务提供带平面图先验的标准测试基准
2.  **配套资源**：包含完整序列分类说明、全部序列的真值数据，以及挑战赛排行榜支持
3.  **使用场景**：适用于视觉惯性SLAM算法研发、定位精度评测、机器人自主导航相关研究与竞赛。
