...
## 主要特性
1.  覆盖完整的具身AI数据层级，从真实场景到仿真、通用网页数据全维度收录
2.  按数据类型分类整理资源，包含实时机器人数据集、野外采集数据集等细分类别
3.  附带完整的模拟器、数据生成系统相关资源
4.  配套收录基于各类数据训练的具身AI模型
5.  欢迎提交PR与issue补充完善资源列表
