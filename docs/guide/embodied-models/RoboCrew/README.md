...
🦾借助LLM智能体让你的机器人实现自主化，它的配置流程和CrewAI或Autogen中的普通智能体一样简单。
...
## 主要特性
1.  **移动控制**：内置轮式移动机器人预构建控制工具
2.  **机械臂操控**：支持VLA模型作为机械臂控制工具
3.  **视觉感知**：提供带图像增强的相机画面，提升空间理解能力
4.  **语音交互**：支持唤醒词语音命令与TTS回复
5.  **LiDAR建图**：可通过LiDAR传感器生成顶视图地图
6.  **多智能体决策**：通过多智能体协作实现自主决策能力
