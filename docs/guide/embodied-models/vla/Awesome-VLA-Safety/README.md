...
## 主要特性
1.  **全面覆盖**：系统性总结VLA模型安全的完整研究框架，包含训练时攻击、推理时安全与鲁棒性等多个维度
2.  **最新整理**：收录该领域前沿的学术研究成果，持续更新相关工作
3.  **开放贡献**：欢迎通过PR或邮件提交新的相关研究，共同完善资源列表
4.  配套了可视化的领域分类图谱，直观展示VLA安全的研究全景。
