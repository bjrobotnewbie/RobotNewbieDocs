...
## 主要特性
1.  支持可穿戴形态的Badge Edition版本
2.  基于开源硬件生态打造，拥有多个硬件版型分支，可自行DIY组装
3.  兼容通用航空的近距离防撞通信标准，实现多机之间的位置数据互通
4.  提供完整的项目文档与构建支持，可通过GitHub Actions完成固件编译
