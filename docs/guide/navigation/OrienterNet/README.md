...
论文"OrienterNet 在带有神经匹配的 2D 公共地图中的视觉定位"源代码
...
## 主要特性
1.  基于神经网络匹配实现视觉定位，仅使用人类通用的2D公开地图即可完成定位
2.  无需依赖3D点云，降低了传统视觉定位方案的硬件与数据门槛
3.  支持Python3.8+与PyTorch框架，提供了完整的部署、训练与评估代码流程
