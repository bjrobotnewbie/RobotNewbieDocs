...
## 主要特性
1.  轻量化易用：仅需简单安装即可直接运行，无需复杂配置
2.  跨平台兼容：支持Linux和macOS操作系统
3.  灵活可调：支持自定义配置文件，可适配室内外不同场景
4.  可复现学术成果：提供对应IROS 2025论文的代码标签，方便研究者复现实验结果
5.  提供Python API，支持二次开发
