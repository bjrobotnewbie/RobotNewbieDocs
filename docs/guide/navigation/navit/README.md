...
## 主要特性
1.  模块化设计，支持多种格式矢量地图渲染与路由计算，兼容OpenStreetMap、Grosser Reiseplaner标准地图，Garmin地图的显示、路由与搜索功能正在开发中
2.  提供GTK、SDL多套用户界面，支持触屏操作
3.  支持多途径获取车辆位置，包括文件/串口、gpsd、移动端定位服务、实验性UDP好友追踪
4.  支持多语言语音导航，拥有活跃的翻译社区
5.  支持导入多种格式的POI数据
