...
| **控制层** | [控制系统](/guide/control/README.md) | 经典控制、现代控制、鲁棒控制 | 🎮 执行控制 |
| **仿真层** | [仿真与世界模型](/guide/simulation/README.md) | MuJoCo、Isaac Sim、Gazebo 等 | 🔬 虚拟验证 |
| **模型层** | [世界模型](/guide/world-models/README.md) | 各类世界模型实现 | 🌍 预测学习 |
| **数据层** | [具身数据](/guide/data/README.md) | 数据集、数据收集、评测基准 | 💾 数据基础 |
| **训练层** | [训练框架](/guide/training/README.md) | Isaac Lab、LeRobot、Habitat Lab 等 | 🎯 模型训练 |
| **部署层** | [模型部署](/guide/deployment/README.md) | vLLM、Ollama 等推理框架 | ⚡ 落地部署 |
| **硬件层** | [硬件系统](/guide/hardware/README.md) | 传感器、电机控制、嵌入式系统 | 🔩 物理实现 |
| **形态层** | [机器人形态分类](/guide/robot-forms/README.md) | 刚性、软体、模块化、群体机器人 | 🤖 形态多样性 |
| **应用层** | [应用场景](/guide/applications/README.md) | 人形、工业、医疗、服务、农业、无人机 | 🏭 场景落地 |
...
- **仿真引擎** - [MuJoCo](/guide/simulation/mujoco/README.md)、[Isaac Sim](/guide/simulation/isaacsim/README.md) 高性能物理仿真
...
> **Q: 我是零基础，应该从哪里开始？**
> 
> 建议先从 [数学基础](/guide/math/README.md) 和 [机器人学原理](/guide/robotics/README.md) 建立理论基础，然后配合 [ROS](/guide/ros/README.md) 教程动手实践。[初学者路径](/guide/other/embodied-ai-start/README.md) 章节有更详细的学习指南。
...
> **Q: 如何在本地运行这些项目？**
> 
> 每个项目的 README 都有详细的环境配置和运行说明。建议先从 [仿真环境](/guide/simulation/README.md) 开始，在 MuJoCo 或 Isaac Sim 中验证算法后再考虑硬件部署。
