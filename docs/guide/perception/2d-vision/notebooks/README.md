...
这是一系列关于前沿计算机视觉模型与技术的教程，涵盖从ResNet这类基础架构到RF-DETR、YOLO11、SAM 3和Qwen3-VL等最新模型的相关内容。
...
## 主要特性
1.  覆盖全层级计算机视觉技术：从基础架构到最新前沿模型
2.  支持多类视觉任务：目标检测、分割、姿态估计、OCR等
3.  提供可直接运行的交互式教程，便于快速上手实践
4.  持续更新收录最新的SOTA视觉模型与方案
