...
模块化开源足式机器人大脑。提供用于远程操作、自主导航、建图与监控的Web界面。支持3D打印硬件，基于ROS2运行。
...
## 主要特性
1.  模块化架构，可按需启用功能，高性能AI模块需搭配Orin AGX使用
2.  集成网页端控制面板，支持单机器人与集群 fleet 操控
3.  支持手动远程遥控、自主导航与SLAM建图功能
4.  提供标准化3D打印硬件安装方案，无需额外定制
5.  支持多语言界面，附带官方演示视频与社区支持渠道
