...
最完整的DDS——久经考验：拥有大量成功案例。正在寻找商业支持？请联系：info@eprosima.com
...
## 主要特性
1.  符合标准的DDS实现，通过FIWARE Robotics认证
2.  支持多操作系统编译运行，配套完整的官方文档
3.  经过持续CI测试保障稳定性，拥有较高的项目活跃度
4.  采用Apache 2.0开源协议，可免费获取源码与使用权限
