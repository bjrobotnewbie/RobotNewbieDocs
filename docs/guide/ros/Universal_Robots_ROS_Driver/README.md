...
支持 CB3 和 e 系列机器人的 Universal Robots ROS 驱动程序
...
## 主要特性
1.  适配UR全系列协作机械臂，支持最新的e-Series机型
2.  提供易用、稳定且功能丰富的ROS交互接口，可用于工业自动化、科研及教育场景
3.  遵循ROS-control相关范式，适配最新ROS版本生态
4.  帮助开发者和研究者规避不必要的技术障碍，专注于机器人应用开发
