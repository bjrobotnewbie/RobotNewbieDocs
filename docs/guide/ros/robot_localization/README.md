...
robot_localization 是一个非线性的状态估计节点包。该包由 Charles River Analytics, Inc. 开发。有关问题，请访问 answers.ros.org。
...
## 主要特性
暂未在当前README中披露详细特性，该包核心为非线性状态估计节点，主要面向机器人领域，用于融合多传感器数据实现精准状态估算。
