...
ros2ai 是基于大语言模型驱动的下一代ROS 2命令行接口扩展
...
## 主要特性
1.  集成OpenAI与Ollama两大LLM服务，支持多模型调用
2.  提供ROS 2命令行交互入口，简化ROS 2相关问题查询流程
3.  支持多语言输出，降低使用门槛
4.  适配ROS 2全系列主流发行版，提供二进制安装方式
5.  面向ROS 2新手友好，无需深入掌握ros2cli即可快速获取帮助
