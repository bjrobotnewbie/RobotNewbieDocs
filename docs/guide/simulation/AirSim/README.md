...
由微软AI与研究部门打造、基于Unreal Engine/Unity开发的开源自动驾驶车辆模拟器
...
## 主要特性
1.  支持多载具仿真，涵盖无人机、汽车等
2.  跨平台兼容，提供Windows、Linux、macOS版本
3.  支持软件在环、硬件在环仿真，适配主流自动驾驶硬件
4.  可作为插件快速集成到Unreal/Unity引擎项目
5.  提供标准化API，支持程序化控制与数据获取，适配AI算法研发场景
