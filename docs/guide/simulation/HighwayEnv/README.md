...
## 主要特性
1.  **核心功能**：提供10类驾驶场景仿真环境，涵盖高速路、环岛、停车场、交叉口等，还支持多智能体、连续控制、联网车道等变体场景。
2.  **使用场景**：适用于自动驾驶算法、SLAM、RL强化学习等自动驾驶相关的算法研发与测试。
3.  **兼容性**：优先支持Linux和macOS，Windows支持为最佳-effort级别，可通过`pip`或`uv`快速安装。
