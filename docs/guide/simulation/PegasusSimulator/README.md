...
基于 NVIDIA Isaac Sim 构建的无人机仿真框架，支持 PX4 并包含更多功能。
...
## 主要特性
1.  基于NVIDIA Isaac Sim构建，具备强大的物理仿真能力
2.  原生支持PX4和ArduPilot飞控，可实现真实飞控联仿
3.  提供自定义Python控制接口，便于快速开发控制算法
4.  支持快速部署无人机仿真场景，简化仿真开发流程
5.  提供完整官方文档，包含安装、使用教程
