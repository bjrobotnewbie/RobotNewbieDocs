...
- [o3de（Open 3D Engine (O3DE…）](/guide/simulation/o3de/README)
- [alien（ALIEN 是一款基于 CUDA 的模拟…）](/guide/simulation/alien/README)
- [ppf-contact-solver（支持物理仿真中接触求解的库，涵盖：👚 壳…）](/guide/simulation/ppf-contact-solver/README)
- [sumo（Eclipse SUMO 是一款开源、高…）](/guide/simulation/sumo/README)
- [openrocket（模型火箭气动与轨迹仿真软件）](/guide/simulation/openrocket/README)
- [bepuphysics2（纯 C# 3D 实时物理仿真库，现已发布…）](/guide/simulation/bepuphysics2/README)
- [renode（Renode - Antmicro 开源…）](/guide/simulation/renode/README)
- [moose（多物理场面向对象仿真环境）](/guide/simulation/moose/README)
- [SU2（SU2：开源多物理场仿真与设计套件）](/guide/simulation/SU2/README)
- [hutb（人车模拟器（Human-Vehicle …）](/guide/simulation/hutb/README)
- [UavNetSim（UavNetSim：一个基于 Pytho…）](/guide/simulation/UavNetSim/README)
- [PteraSoftware（Ptera 软件是一款快速、易用且开源的…）](/guide/simulation/PteraSoftware/README)
- [SimART（一个面向所有场景的开源软件平台，用于无线…）](/guide/simulation/SimART/README)
- [MuJoCo-LiDAR（基于 MuJoCo 的高性能 LiDAR…）](/guide/simulation/MuJoCo-LiDAR/README)
- [OceanGym（[EMNLP 2026] OceanGy…）](/guide/simulation/OceanGym/README)
- [PositionBasedDynamics（PositionBasedDynamic…）](/guide/simulation/PositionBasedDynamics/README)
- [SPlisHSPlasH（SPlisHSPlasH 是一个开源库，…）](/guide/simulation/SPlisHSPlasH/README)
