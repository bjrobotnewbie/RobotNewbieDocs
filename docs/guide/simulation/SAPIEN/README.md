...
## 主要特性
1.  3.0版本重构了核心架构，采用实体-组件系统，支持PhysX 5 GPU仿真，可用于构建机器人学习环境
2.  支持光线追踪、GPU加速立体深度传感器仿真、渲染服务器
3.  兼容Python 3.11，提供无显示器服务器和虚拟桌面两种部署方式
4.  提供丰富的部件级物体数据集，可支撑各类机器人交互与视觉研究任务
