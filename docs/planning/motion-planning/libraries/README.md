...
| 库 | 核心算法 | 规划类型 | 特点 |
|----|---------|---------|------|
| [**OMPL**](planning/motion-planning/libraries/ompl/README.md) | RRT*, PRM, EST 等 | 基于采样 | 算法丰富，高性能 |
| [**SBPL**](planning/motion-planning/libraries/sbpl/README.md) | A*, ARA*, R* | 基于搜索 | 最优性保证，增量规划 |
