...
### 传统任务规划
- [行为树 (Behavior Tree)](planning/task-planning/classical/behavior-tree/README.md)
- [层次任务网络 (HTN)](planning/task-planning/classical/htn/README.md)
- [规划域定义语言 (PDDL)](planning/task-planning/classical/pddl/README.md)

### LLM 驱动的规划
- [ReAct (推理+行动)](planning/task-planning/llm-driven/react/README.md)
- [Reflexion (反思式规划)](planning/task-planning/llm-driven/reflexion/README.md)
- [AutoGen (多智能体协作)](planning/task-planning/llm-driven/autogen/README.md)
